...
$(document).ready(function() {
    ...
    for(i = 1; i < 6; i++) {
        for(j = 1; j < 6; j++) {
            ...
            $('#crd' + i + j).text(cartitas["" + i + j].palabra).css('font-size', '25px');
...
function newGame() {
    ...
    for(i = 1; i < 6; i++) {
        for(j = 1; j < 6; j++) {
            ...
            cartitas["" + i + j] = new Tarjeta(i, j, word, tipo);
            $('#crd' + i + j).text(cartitas["" + i + j].palabra).css('font-size', '15px');
